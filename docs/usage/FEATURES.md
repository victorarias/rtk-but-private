...
Ce fork ne collecte ni ne transmet aucune donnee d'utilisation. Tout le suivi est local (SQLite dans `~/.local/share/rtk/history.db`) et alimente `rtk gain` sur votre machine. Aucun envoi reseau.
